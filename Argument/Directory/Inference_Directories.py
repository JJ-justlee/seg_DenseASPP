...
def Inference_Dics_args():
    ...
    parser.add_argument('--model_name', type=str,   help='Customized DenseASPP', default='test_MobileNetDenseASPP')    
    ...
    parser.add_argument('--pred_dir', type=str, help='prediction image directory',
                        default=osp.join(args.exp_dir, args.model_name, 'prediction1'))
